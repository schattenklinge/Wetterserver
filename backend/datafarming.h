...
#ifndef DATAFARMING_H_
#define DATAFARMING_H_
...
void insertTemp( Te923DataSet_t *data, char *iText );
void insertWind( Te923DataSet_t *data, char *iText );
void insertStatus( Te923DataSet_t *data, char *iText );
void insertRain( Te923DataSet_t *data, char *iText );
#endif // DATAFARMING_H_
